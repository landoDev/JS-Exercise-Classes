...
class Instructor extends Lambdasian {
  constructor(personalInfo){
    super(personalInfo)
    this.specialty = personalInfo.specialty;
    this.favLanguage = personalInfo.favLanguage;
    this.catchPhrase = personalInfo.catchPhrase;
  }
  demo(subject){
...
class Student extends Lambdasian {
  constructor(personalInfo){
    super(personalInfo)
    this.previousBackground = personalInfo.previousBackground;
    this.className = personalInfo. className;
    this.favSubjects = personalInfo.favSubjects;
  }
  listSubjects(){
